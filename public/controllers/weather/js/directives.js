...
angular.module('planApp.directives', [])
  ...
  .directive('weatherPanel',[function factory() {
    return {
      ...
      templateUrl: '../controllers/weather/partials/_weather-panel-light.html',
...
.directive('weatherPanelWind',[function factory() {
  return {
    ...
    templateUrl: '../controllers/weather/partials/_weather-panel-wind.html',
